...
def build_graph(observations):
    ...
    """Calculate logits from the input observations tensor.
    ...
    with tf.variable_scope('model', reuse=tf.AUTO_REUSE):
        ...
        # output probabilities for each action : NOOP, UP, DOWN
...
def main(args):
    ...
    with tf.Graph().as_default() as g:
        ...
        with tf.name_scope('summaries'):
            ...
            # the weights to the hidden layers can be visualized
    ...
    with tf.Session(graph=g) as sess:
        ...
        '''lowest possible score after an episode as the starting
        values of the running reward'''
        ...
        for i in range(args.n_epoch):
            ...
            if _global_step % args.save_checkpoint_steps == 0:
                ...
                save_path = os.path.join(args.output_dir, 'model_ckpt')
